...
gulp.task('templates', function() {
    ...
    console.log('>>>> STARTING TEMPLATES TASK ðŸ“„  <<<<');
...
gulp.task('clean', function() {
    ...
    console.log('>>>> STARTING DEL TASK âœ‚ï¸  <<<<');
...
gulp.task('copy', function () {
    return gulp.src('src/static/*.{jpg,zip}')
